...
function CategoryList() {
  ...
  return (
    <div>
      <div>
        <div className="flex h-10 font-semibold justify-between items-center bg-gray-100 pl-3 border border-gray-200">
      ...
      <div className="flex flex-wrap justify-around mt-4">
        {categories.map((category, index) => (
          <div
            ...
            key={index}
            className={`md:w-1/5 relative text-center font-medium border cursor-pointer border-gray-100 p-10 m-4 bg-gray-100 hover:bg-gray-200 ${
